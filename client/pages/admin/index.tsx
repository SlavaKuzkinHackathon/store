          ...
          {({
            ...
            <Form className={styles.form}>
              ...
              <label>
                ...
                <Field className={styles.input} name={'catalogId'} as="select">
                  ...
                  return (
                    <div key={info.id} className={styles.info}>
                      ...
                      <span
                        onClick={() => {
                          setProductInfos(
                            productInfos.filter((item) => item.id !== info.id)
                          )
                        }}
      ...
      children: (
        <Formik
          ...
          onSubmit={async (
            ...
            dispatch(ProductAsyncActionCreators.removeProduct(values.productId))
            formikHelpers.setSubmitting(false)
          }}
        >
          {({
            ...
            <Form>
              ...
              <Field className={styles.input} name={'productId'} as="select">
                <option value={0} disabled>
                  Выберите товар
                </option>
  ...
  return (
    <div>
      <Section title="Админ-панель">
        ...
        {/*   <Tabs.TabPane tab="Добавить товар" key="1"></Tabs.TabPane>
          <Tabs.TabPane tab="Добавить каталог" key="2"></Tabs.TabPane>
          <Tabs.TabPane tab="Удалить товар" key="3"></Tabs.TabPane> */}
        </Tabs>
      </Section>
    </div>
  )
